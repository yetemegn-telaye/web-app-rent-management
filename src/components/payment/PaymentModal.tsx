        ...
        <div className="flex p-4 rounded-lg shadow-sm">
          ...
          <div className=" text-right">
            ...
            <div className="mb-4 space-y-3">
              ...
              <p className="text-gray-600"><strong>Payment Date:</strong> {payment.date}</p>
              <p className="text-gray-600"><strong>Amount:</strong> {payment.amount} ETB</p>
              <p className="text-gray-600"><strong>Utility Payment:</strong> {payment.utility} ETB</p>
              <p className="text-gray-600"><strong>Total Amount:</strong> {payment.totalAmount} ETB</p>
